...
│   ├── pages/           # App pages (Home, Events, Profile, etc.)
│   ├── App.jsx          # Root component with routing
│   ├── main.jsx         # App entry point
│   ├── index.css        # Global styles
│   └── App.css          # Component/global styling
├── data/                # Local data / constants (if applicable)
...
git clone https://github.com/your-username/connvia-frontend.git
