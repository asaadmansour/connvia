    ...
    <div className={styles.successContainer}>
      ...
      <div className={styles.verificationNote}>
        <div className={styles.noteIcon}>
          ...
          >
            <path
              d="M10 0C4.48 0 0 4.48 0 10C0 15.52 4.48 20 10 20C15.52 20 20 15.52 20 10C20 4.48 15.52 0 10 0ZM10 18C5.58 18 2 14.42 2 10C2 5.58 5.58 2 10 2C14.42 2 18 5.58 18 10C18 14.42 14.42 18 10 18ZM11 5H9V11H15V9H11V5Z"
              fill="#FFD54F"
            />
          </svg>
        </div>
      ...
      <div className={styles.actionButtons}>
        <button className={styles.loginButtonDisabled} disabled>
          {t("signup.success.goToLogin")} (Verify Email First)
        </button>
    ...
    t: (key) => {
      const translations = {
        ...
        "signup.success.verification":
          "Please check your email and click the verification link to activate your account. You cannot login until your email is verified.",
